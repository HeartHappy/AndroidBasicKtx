 ...
 */
class Example2Adapter(private val context: Context) : AbsSpecialAdapter<ItemGridListBinding, String>(), IHeaderSupport<ItemHeaderBinding>, IFooterSupport<ItemFooterBinding>, IEmptyViewSupport<ItemEmptyViewBinding> {
    override fun initViewBinding(parent: ViewGroup, viewType: Int): ItemGridListBinding {
        return ItemGridListBinding.inflate(LayoutInflater.from(context), parent, false)
    }
